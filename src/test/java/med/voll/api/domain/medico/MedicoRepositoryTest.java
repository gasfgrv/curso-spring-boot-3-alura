...
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deveria retornar 'null' quando o unico médico cadastrado não estivar disponível na data")
    void testEscolherMedicoAleatorioLivreNaDataCenario1() {
        var proximaSegundaAs10 = LocalDate.now()
                .with(TemporalAdjusters.next(DayOfWeek.MONDAY))
                .atTime(10, 0);

        var medico = cadastrarMedico("Médico", "teste@email.com", "123456", Especialidade.CARDIOLOGIA);
    ...
    @Test
    @DisplayName("Deveria retornar medico quando ele estivar disponível na data")
